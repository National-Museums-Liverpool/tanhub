    ...
    <div class="row g-4 align-items-stretch">
        <div class="col-lg-5">
            <div class="auth-panel p-4 p-lg-5 h-100">
                ...
                <h1 class="section-heading mb-3">Family details</h1>
                <p class="section-copy mb-4">Read-only values from the families reference table.</p>
            </div>
        </div>
        <div class="col-lg-7">
            <div class="auth-card p-4 p-lg-5">
                <div class="row g-3">
                    ...
                    <?php foreach ($fields as $field => $label): ?>
                        <div class="col-12">
                            ...
                            <input class="form-control" id="<?= esc($field) ?>" type="text" value="<?= esc((string) ($page['family'][$field] ?? '')) ?>" disabled>
                        </div>
                    <?php endforeach; ?>
                ...
                <div class="d-flex flex-column flex-sm-row gap-3 align-items-sm-center justify-content-between mt-4">
                    <a class="btn btn-outline-brand" href="<?= esc(site_url('families')) ?>">Back to list</a>
                </div>
            </div>
        </div>
    </div>
