...
$routes->get('taxon-media-imports', 'TaxonMediaImports::index', ['filter' => ['session', 'group:admin,manager']]);
$routes->post('taxon-media-imports', 'TaxonMediaImports::store', ['filter' => ['session', 'group:admin,manager', 'csrf']]);
$routes->post('taxon-media-imports/create', 'TaxonMediaImports::create', ['filter' => ['session', 'group:admin,manager', 'csrf']]);
$routes->get('taxon-media-imports/(:segment)/status', 'TaxonMediaImports::status/$1', ['filter' => ['session', 'group:admin,manager']]);
$routes->get('taxon-media-imports/(:segment)/report', 'TaxonMediaImports::report/$1', ['filter' => ['session', 'group:admin,manager']]);
$routes->post('taxon-media-imports/(:segment)/files', 'TaxonMediaImports::upload/$1', ['filter' => ['session', 'group:admin,manager', 'csrf']]);
$routes->post('taxon-media-imports/(:segment)/finalize', 'TaxonMediaImports::finalize/$1', ['filter' => ['session', 'group:admin,manager', 'csrf']]);
$routes->post('taxon-media-imports/(:segment)/process', 'TaxonMediaImports::process/$1', ['filter' => ['session', 'group:admin,manager', 'csrf']]);
$routes->post('taxon-media-imports/(:segment)/retry', 'TaxonMediaImports::retry/$1', ['filter' => ['session', 'group:admin,manager', 'csrf']]);
$routes->post('taxon-media-imports/(:segment)/cancel', 'TaxonMediaImports::cancel/$1', ['filter' => ['session', 'group:admin,manager', 'csrf']]);
...
$routes->get('data-sources', 'DataSources::index', ['filter' => ['session', 'group:admin,manager']]);
$routes->post('data-sources/create', 'DataSources::store', ['filter' => ['session', 'group:admin,manager']]);
$routes->get('data-sources/(:num)', 'DataSources::details/$1', ['filter' => ['session', 'group:admin,manager']]);
$routes->post('data-sources/(:num)', 'DataSources::update/$1', ['filter' => ['session', 'group:admin,manager']]);
$routes->get('occurrences', 'Occurrences::index', ['filter' => ['session', 'group:admin,manager']]);
$routes->get('occurrences/(:num)', 'Occurrences::details/$1', ['filter' => ['session', 'group:admin,manager']]);
$routes->post('occurrences/(:num)', 'Occurrences::update/$1', ['filter' => ['session', 'group:admin,manager']]);
