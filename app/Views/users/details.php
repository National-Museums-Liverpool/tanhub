    ...
    <div class="row g-4 align-items-stretch">
        <div class="col-lg-5">
            <div class="auth-panel p-4 p-lg-5 h-100">
                ...
                <h1 class="section-heading mb-3">Edit user</h1>
                <p class="section-copy mb-4">Update account details, passwords, and active status.</p>
            </div>
        </div>
        <div class="col-lg-7">
                ...
                <form action="<?= esc(site_url('users/' . $page['managedUser']->id)) ?>" method="post" novalidate>
                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            ...
                            <input class="form-control" id="id" type="text" value="<?= esc((string) $page['managedUser']->id) ?>" disabled>
                        </div>
                        <div class="col-md-8">
                            <label class="form-label" for="groups">
                                Current groups
                                <span class="badge bg-secondary ms-2">Read-only summary</span>
                            </label>
                            <input class="form-control" id="groups" type="text" value="<?= esc(implode(', ', $page['groups'])) ?>" disabled>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label" for="username">Username</label>
                            <input class="form-control<?= isset($errors['username']) ? ' is-invalid' : '' ?>" id="username" name="username" type="text" maxlength="30" value="<?= esc(old('username', (string) $page['managedUser']->username)) ?>" autocomplete="username">
                        ...
                        <div class="col-md-6">
                            ...
                            <input class="form-control<?= isset($errors['email']) ? ' is-invalid' : '' ?>" id="email" name="email" type="email" maxlength="254" value="<?= esc(old('email', $page['email'])) ?>" autocomplete="email">
                        ...
                        <div class="col-md-6">
                            ...
                            <?php $activeValue = old('active', ! empty($page['managedUser']->active) ? '1' : '0'); ?>
                        ...
                        <div class="col-12">
                            ...
                            <?php $selectedGroups = old('groups', $page['groups']); ?>
                            <?php if (! is_array($selectedGroups)): ?>
                                <?php $selectedGroups = $page['groups']; ?>
                            <?php endif; ?>
                        ...
                        <div class="col-md-6">
                            ...
                            <input class="form-control<?= isset($errors['password']) ? ' is-invalid' : '' ?>" id="password" name="password" type="password" autocomplete="new-password" placeholder="Leave blank to keep existing password">
