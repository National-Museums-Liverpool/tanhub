...
<section class="page-section">
    <div class="auth-card p-4 p-lg-5">
        ...
        <form class="row g-2 mb-4" method="get" action="<?= esc(site_url('taxon-groups')) ?>">
            <div class="col-12 col-md-8 col-lg-6">
                <label class="visually-hidden" for="q">Search</label>
                <input class="form-control" id="q" name="q" type="search" value="<?= esc($q) ?>" placeholder="Search taxon groups...">
            </div>
            <div class="col-auto">
            ...
            <?php if ($q !== ''): ?>
                <div class="col-auto">
                    <a class="btn btn-outline-secondary" href="<?= esc(site_url('taxon-groups')) ?>">Clear</a>
                </div>
            <?php endif; ?>
        </form>
